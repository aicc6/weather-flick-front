            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  본 약관은 Weather Flick(이하 "회사")이 제공하는 날씨 기반
                  맞춤형 여행 추천 서비스(이하 "서비스")의 이용과 관련하여
              ...
              <div>
                ...
                <ol className="list-inside list-decimal space-y-2 text-gray-700 dark:text-gray-300">
                  <li>
                    "서비스"란 회사가 제공하는 날씨 정보를 기반으로 한 여행지
                    추천, 여행 계획 수립, 여행 리뷰 등과 관련된 모든 서비스를
                    의미합니다.
                  </li>
                  <li>
                    "이용자"란 본 약관에 따라 회사와 이용계약을 체결하고 회사가
                    제공하는 서비스를 이용하는 회원 및 비회원을 의미합니다.
                  </li>
                  <li>
                    "회원"이란 회사에 개인정보를 제공하여 회원등록을 한 자로서,
                    회사의 정보를 지속적으로 제공받으며, 회사가 제공하는
